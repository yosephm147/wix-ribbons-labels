...
export const SHAPE_DEFAULTS: Record<string, { width: number; height: number }> =
  {
    ...
    "diagonal-slash": { width: 100, height: 20 },
    "diagonal-slash-flipped": { width: 100, height: 20 },
...
export const SHAPE_TEXT_SIZE_DEFAULTS: Record<string, number> = {
  ...
  "double-arrow": 50,
  "diagonal-slash": 60,
  "diagonal-slash-flipped": 60,
  "diagonal-slash-round": 60,
  "diagonal-slash-round-rotated": 60,
  "corner-tr": 24,
  "corner-tl": 24,
  trapezoid: 50,
  "trapezoid-inv": 50,
